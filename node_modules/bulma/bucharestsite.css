@import url(https://fonts.googleapis.com/css?family=Kurale&subset=cyrillic,latin-ext);
@import url(https://fonts.googleapis.com/css?family=Noto+Sans:400,700&subset=cyrillic,latin-ext);
...
a.box:hover, a.box:focus {
  box-shadow: 0 2px 3px rgba(17, 17, 17, 0.1), 0 0 0 1px #beccd8; }
a.box:active {
  box-shadow: inset 0 1px 2px rgba(17, 17, 17, 0.2), 0 0 0 1px #beccd8; }
...
.button {
  ...
  .button.is-light {
    ...
    .button.is-light.is-loading:after {
      border-color: transparent transparent #fffdfa #fffdfa !important; }
...
a.nav-item {
  ...
  a.nav-item.is-tab {
    ...
    a.nav-item.is-tab.is-active {
      border-bottom: 3px solid #beccd8;
...
.hero {
  ...
  .hero.is-light {
    ...
    .hero.is-light .subtitle {
      ...
      .hero.is-light .subtitle strong {
        color: #fffdfa; }
    .hero.is-light .nav {
      box-shadow: 0 1px 0 rgba(255, 253, 250, 0.2); }
    @media screen and (max-width: 768px) {
    ...
    @media screen and (max-width: 768px) {
      ...
      .hero.is-light .nav-menu .nav-item {
        border-top-color: rgba(255, 253, 250, 0.2); } }
  .hero.is-dark {
    background-color: #fffdfa;
    color: #f5f7fa; }
    .hero.is-dark .title {
    ...
    .hero.is-dark.is-bold {
      background-image: linear-gradient(141deg, #ffdfc7 0%, #fffdfa 71%, white 100%); }
    @media screen and (max-width: 768px) {
  ...
  .hero.is-primary {
    ...
    .hero.is-primary.is-bold {
      background-image: linear-gradient(141deg, #96bdcd 0%, #beccd8 71%, #ccd5e4 100%); }
    @media screen and (max-width: 768px) {
...
/*# sourceMappingURL=bucharestsite.css.map */
